...
using BlazorDataverse.Models;

namespace BlazorDataverse
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var GDSBaseUrl = GDSWebApiConfig.GetSection("BaseUrl").Value;
            var GDSVersion = GDSWebApiConfig.GetSection("Version").Value;
            ...
            var baseUrl = CDSWebApiConfig.GetSection("BaseUrl").Value;
            ...
            builder.Services.AddHttpClient("CDSClient", client =>
            {
                ...
                client.BaseAddress = new Uri($"{baseUrl}/api/data/{version}");
            });
            ...
            builder.Services.AddMsalAuthentication(options =>
            {
                ...
                options.ProviderOptions.DefaultAccessTokenScopes.Add($"{GDSBaseUrl}/user_impersonation");
            });
